 ...
 */
package com.wallethub.backendwallethub.configuration;
...
@ComponentScan({"com.wallethub.backendwallethub.configuration"})
public class HibernateConfiguration {
    ...
    public DataSource dataSource() throws NamingException {
        ...
        return dsLookup.getDataSource("jdbc/walletHub");
    }
